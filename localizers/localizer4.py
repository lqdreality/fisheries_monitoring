...
selected_aug = {"ALB" : ["original", "vflip", "rotate", "invert", "add", "emboss", "gaussianNoise", "blur", "dropout"],
                "BET" : ["original", "vflip", "rotate", "invert", "add", "emboss", "gaussianNoise", "blur", "dropout"],
                "DOL" : ["original", "vflip", "rotate", "invert", "add", "emboss", "gaussianNoise", "blur", "dropout"],
                "LAG" : ["original", "vflip", "rotate", "invert", "add", "emboss", "gaussianNoise", "blur", "dropout"],
                "OTHER" : ["original", "vflip", "rotate", "invert", "add", "emboss", "gaussianNoise", "blur", "dropout"],
                "SHARK" : ["original", "vflip", "rotate", "invert", "add", "emboss", "gaussianNoise", "blur", "dropout"],
                "YFT" : ["original", "vflip", "rotate", "invert", "add", "emboss", "gaussianNoise", "blur", "dropout"]}
...
history = model.fit_generator(generator = data_generator(batch_size, aug_train_labels, INPUT_WIDTH, INPUT_HEIGHT), 
                              ...
                              validation_steps = 5)
model.save(DATA_PATH + 'models/localizers/localizer4.h5')
